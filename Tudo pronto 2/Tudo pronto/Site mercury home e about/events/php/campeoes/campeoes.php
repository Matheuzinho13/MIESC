        ...
        if (isset($_FILES['lugar1'])  && isset($_FILES['lugar2'])  && isset($_FILES['lugar3']))  {
           ...
           if ($deu_certo1 && $deu_certo2 && $deu_certo3) {
                   $mysqli->query("INSERT INTO vencedores (path, path2, path3, ano) VALUES('$path', '$path2', '$path3', $ano)") or die($mysqli->error);
        ...
        $sql_query_time1 = $mysqli->query("SELECT * FROM vencedores WHERE path = '$path'") or die($mysqli->error);
        $sql_query_time2 = $mysqli->query("SELECT * FROM vencedores WHERE path2 = '$path2'") or die($mysqli->error);
        $sql_query_time3 = $mysqli->query("SELECT * FROM vencedores WHERE path3 = '$path3'") or die($mysqli->error);

        $ano_query = $mysqli->query("SELECT DISTINCT ano FROM vencedores WHERE path = '$path'") or die($mysqli->error);
    ...
    <body>
        ...
        <nav class="miesc">
            ...
            <div class="nav-list">
                ...
                <ul>
                    ...
                    <li class="updraft"><a href="campeoes.php" class="nav-link">Campeões</a></li>
        ...
        <div class="fundo">
            ...
            <form action="campeoes.php" method="POST" enctype="multipart/form-data">
        <div class="anos">
            <div class="grupo">
...
<div class="box3">
    ...
    text-align: center;
			  ...
			  <a class='btn btn-sm btn-danger' name="delete" href='conexaodelete.php?id=<?php echo $dado["id"]; ?>'>
