...
if(isset($_POST['submit']))
{
    ...
    if (isset($_FILES['arquivo1']) && isset($_FILES['arquivo2'])) {
        ...
        if ($deu_certo1 && $deu_certo2) {
            ...
            $conexao->query("INSERT INTO resultados (resultado, turma, turma2, nome, path, path2) 
...
$sql_query_path1 = $conexao->query("SELECT * FROM resultados WHERE path = '$path1'");
$sql_query_path2 = $conexao->query("SELECT * FROM resultados WHERE path2 = '$path2'");
?>
