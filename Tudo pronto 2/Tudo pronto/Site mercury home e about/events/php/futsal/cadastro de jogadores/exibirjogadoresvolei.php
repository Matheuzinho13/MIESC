<?php  
   include_once('conexao.CJ.basquete.php');
   
$consulta = "SELECT * FROM jogadoresvolei";
...
<head>
<meta charset="utf-8">
<title>Exibir jogadores volei</title>
	<link rel="stylesheet" href="../../../css/exibirjogadores2.css">
...
<body>
	...
	<table border="2" bordercolor="#0E3659">
		<tr>
			...
			<td><div class= "nom"><h2>Nome</h2></div></td>
	...
	<tr>
			...
			<td><div class="sala"><?php echo $dado["turma"]; ?></div></td>
           <td><div class="nome"><?php echo $dado["nome"]; ?></div></td>
    ...
    <p>Organização, comunicação e <br> união, na palma da sua mão. </p>
        ...
        <ul class="footer-list">
            ...
            <li>
             ...
             <li>
                <a href="../../sarau e paulo freire/Paulo Freire/pauloFreireadm.html" class="footer-link">Paulo Freire</a>
            </li>
