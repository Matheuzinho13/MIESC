...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($conexao, "INSERT INTO textos(jogos, turma, turma2)
...
$sql_query_time1 = $conexao->query("SELECT * FROM textos WHERE time = 1");
$sql_query_time2 = $conexao->query("SELECT * FROM textos WHERE time = 2");
?>
...
<link rel="stylesheet" href="../../css/futsal2usu.css">
