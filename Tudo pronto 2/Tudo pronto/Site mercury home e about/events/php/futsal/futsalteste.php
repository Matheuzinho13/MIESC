<?php  
   ...
   if(isset($_POST['submit']))
   {
       ...
       if (isset($_FILES['arquivo1']) && isset($_FILES['arquivo2'])) {
           ...
           if ($deu_certo1 && $deu_certo2) {
               ...
               $conexao->query("INSERT INTO textos (jogos, turma, turma2, nome, path, path2) 
   ...
   $sql_query_path1 = $conexao->query("SELECT * FROM textos WHERE path = '$path1'");
   $sql_query_path2 = $conexao->query("SELECT * FROM textos WHERE path2 = '$path2'");
?>
...
<title>Futsal Adm</title>
	<link rel="stylesheet" href="../../css/futsal2.css">
...
.fundo{
    ...
    min-height: 108vh;
    background-image:url("../../img e/Ondas/onda futsal.png");
...
<div class="textos">
  <h1>Veja os jogadores cadastrados
</h1>
  <br>
  <div class="botao3">
  	<a href="cadastro de jogadores/exibirjogadoresfutsal.php">
...
.benviar{
  ...
  .container {
   ...
   <form action="futsalteste.php" method="post" enctype="multipart/form-data">
    <div class="geral">
    <div class="box4">
            <div class="inputBox">
  ...
  <!-- Começo editar e excluir -->
			 ...
			 <td class="editar"><a class='btn btn-sm btn-primary' href='editFutsaladm.php?id=<?php echo $dado["id"]; ?>'> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
				 </a>
			  <a class='btn btn-sm btn-danger' href='deleteFutsal.php?id=<?php echo $dado["id"]; ?>'>
