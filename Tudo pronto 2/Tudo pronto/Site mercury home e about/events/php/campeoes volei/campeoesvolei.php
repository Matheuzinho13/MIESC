    ...
    <body>
        ...
        <nav class="miesc">
            ...
            <li class="nav-item"><a href="../../../Site mercury home e about/htmls/index adm.html" class="nav-link">About</a></li> 
                ...
                <li class="updraft"><a href="campeoesvolei.php" class="nav-link">Campeões</a></li>
        ...
        <div class="fundo">
            ...
            <form action="campeoesvolei.php" method="POST" enctype="multipart/form-data">
        <div class="anos">
            <div class="grupo">
    ...
    <div class="inputBox2">
        ...
        <h3 class="anophp"> <?php echo $dado['ano']; ?></h3>
            <div class="deletar">
			  ...
			  <a class='btn btn-sm btn-danger' name="delete" href='conexaodeletevolei.php?id=<?php echo $dado["id"]; ?>'>
