...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.min.js"></script>
    ...
    <header>
        <nav class="miesc">
            <div class="logo">
                <img src="img/miesc.png" widht="30px" height="60px">       
            </div>
            <div class="nav-list">
            <ul>
    ...
    <form action="fotosPF.php" method="post" enctype="multipart/form-data">
    <div class="botao4">
    ...
    echo '<img src="postagens/' . $nomeArquivo . '" alt="' . $nomeArquivo . '">';
	echo ' <div class="bootstrap-buttons">';
    echo '<a class="btn btn-sm btn-danger delete-btn" name="delete" href="deletefotopf.php?id=' . $id . '">
