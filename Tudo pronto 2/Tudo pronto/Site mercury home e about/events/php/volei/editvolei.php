...
.editar{
    ...
    border-radius: 5px;
        ...
        <form action="saveEditVolei.php" method="post" enctype="multipart/form-data">
        <div class= "times">
    ...
    <div class="box4">
        ...
        <div class= "geral">
         <div class="box">
         <div class="inputBox">
                <input type="text" name="jogos" id="jogos" class="inputUser" required value="<?php echo $jogos ?>">
