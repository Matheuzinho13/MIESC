...
if (isset($_POST['atualizar'])) {
    ...
    $sqlUpdate = "UPDATE basquete SET jogos='$jogos', turma='$turma', turma2='$turma2', path='$path', path2='$path2' WHERE id='$id'";
...
.editar{
    ...
    border-radius: 5px;
        ...
        <form action="saveEditBasquete.php" method="post" enctype="multipart/form-data">
        <div class= "times">
