...
if(isset($_POST['submit']))
{
    ...
    if (isset($_FILES['arquivo1']) && isset($_FILES['arquivo2'])) {
        ...
        if ($deu_certo1 && $deu_certo2) {
            ...
            $conexao->query("INSERT INTO resultadosvolei (resultado, turma, turma2, nome, path, path2) 
...
$sql_query_path1 = $conexao->query("SELECT * FROM resultadosvolei WHERE path = '$path1'");
$sql_query_path2 = $conexao->query("SELECT * FROM resultadosvolei WHERE path2 = '$path2'");
?>
           ...
           <li class="nav-item"><a href="../../../Site mercury home e about/htmls/home adm.html" class="nav-link">Home</a></li>  
			...
			<li class="nav-item"><a href="" class="nav-link">Resources</a>
              <ul>
                ...
                <li class="updraft"><a href="../classificacao volei/classificacaovolei.php" class="nav-link">Classificação</a></li> </li>
             </ul>
             </li>
			</ul>
	  </div>
...
.enviarbd{
   ...
   <form action="resultado.php" method="post" enctype="multipart/form-data">
    ...
    <div class="box4">
        ...
        <div class="box">
            <div class="inputBox">
                <input type="text" name="resultado" id="id" class="inputUser" required>
